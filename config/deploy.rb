...
set :wp_sitename, 'gef-mozambique'
...
set :application, 'gef-mozambique'
set :repo_url, 'git@github.com:unepwcmc/gef_mozambique.git'
...
set :linked_files, %w(wp-config.php .htaccess robots.txt index.php content/themes/gef-mozambique/.env)
