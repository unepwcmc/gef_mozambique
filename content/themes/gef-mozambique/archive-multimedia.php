 ...
 */
	...
	set_query_var( 'hero-text', get_theme_mod( 'multimedia_hero_text' ) );
	$hero_link = get_theme_mod( 'multimedia_hero_button_link' ) != 0
		? get_page_link( get_theme_mod( 'multimedia_hero_button_link' ) )
		: '';
	set_query_var( 'hero-link-url', $hero_link );
	set_query_var( 'hero-link-text', get_theme_mod( 'multimedia_hero_button_text' ) );
